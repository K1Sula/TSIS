...
def show_score(color, font, size):
    ...
    score_rect.x, score_rect.y = 0, 0 #start poiny for rect font
...
while RUN:
    ...
    if SCORE_N >= 3 and not level_added and SCORE != 0: # example 10 #next loop again 10 but here is true so added only one time
        LEVEL += 1
        SCORE_N = 0
        FPS += 1
        level_added = True
...
# what was my mistake?
# the size of the map was wrong 1200 by 1000 and the start point was also 200 by 50
# it didn't work right because the size of my block was 30 by 30 but the start point and all that didn't fit. 